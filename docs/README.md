...
penetration testing platform that turns 27+ Kali Linux security tools into 114
...
- [Tool Reference](tools.md) — all 114 tools, grouped by phase, with parameters
...
- **Finding** — a single structured result (an open port, a vulnerability, a
  ...
  `evidence`.
- **Tool** — an AI-callable action (e.g. `nmap_port_scan`). 114 are available.
